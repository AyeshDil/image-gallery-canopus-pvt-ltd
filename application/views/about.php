    ...
    <div class="container d-flex justify-content-center">
      <div style=" background-color: #474448; color: white; border-radius: 30px;" class="col-lg-6 m-5 p-5">
        <div class="row">
          ...
          <h4 class="text-center">Site developed by:
            <a href="mailto:dilshanwma@gmail.com" style="color: whitesmoke;">W. M. Ayesh Dilshan</a>
          </h4>
          <p class="mt-3">
          ...
          <div class="col col-lg-12 d-flex justify-content-center mt-3">
            <a href="<?php echo base_url('index.php/Login'); ?>">
              <button class="btn btn-dark" style="background-color: black;">
